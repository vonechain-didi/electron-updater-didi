...
export declare type UpdaterEvents = "login" | "checking-for-update" | "update-available" | "update-cancelled" | "download-progress" | "update-downloaded" | "error" | "abort-download";
export declare const DOWNLOAD_PROGRESS: UpdaterEvents;
export declare const UPDATE_DOWNLOADED: UpdaterEvents;
export declare const ABORT_DOWNLOAD: UpdaterEvents;
